...
function init() {
	...
	//Adding clues
 	...
 	clue1.clueInfo = makeInfoSprite("./assets/wallet_Image.png", 400, 300);
 	stage.addChild(clue1);
 	
 	clue2 = new Clue(700, 500, 1, "./assets/photo.png", 24,24, "photo");
 	clue2.clueInfo = makeInfoSprite("./assets/ID.png", 400, 300);
 	stage.addChild(clue2);
 	
 	clue3 = new Clue(600, 500, 1, "./assets/drugs.png", 24,24, "drugs");
 	clue3.clueInfo = makeInfoSprite("./assets/Drugs&Medicine.png", 400, 300);
